...
tracker_lock_global: Lock = mp_manager.Lock() # process holds when running profiling
tracker_lock_holder_pid: SynchronizedBase = multiprocessing.Value("i", 0) # process that holds the lock
proc_map_global: Dict[int, MultiprocessPatch] = {} # port to process object mapping
