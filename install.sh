...
sudo apt-get update
echo "[+] Executing 'sudo apt-get -y install curl git redis python3.7-minimal python3-redis python3-pip python3-watchdog nodejs npm iptables'"
sudo apt-get -y install curl git redis python3.7-minimal python3-redis python3-pip python3-watchdog nodejs npm iptables
...
pip3 install maxminddb colorama validators urllib3 requests numpy sklearn pandas certifi keras redis==3.4.1
