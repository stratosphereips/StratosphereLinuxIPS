...
be found in modules/fides_module/model. The reader may find that all of the floating variables are in the interval <-1; 1>
and some of them are between <0; 1>, please refer to the modules/fides_module/model directory.
...
For more information about message handling, please also refer to modules/fides_module/messaging/message_handler.py
and to modules/fides_module/messaging/dacite/core.py for message parsing.
...
**Used Channels**
modules/fides_module/messaging/message_handler.py
...
Implementations of Fides_Module-network-communication can be found in ```modules/fides_module/messaging/network_bridge.py```.
