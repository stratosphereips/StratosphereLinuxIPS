...
class Main:
    ...
    def start(self):
        ...
        try:
            ...
            self.rdb = Redis(self.redis_port)
            ...
            # if slips is given a .self.rdb file, don't load the modules as we don't need them
            if not self.args.db:
            ...
            is_interface: bool = self.args.interface or self.rdb.is_growing_zeek_dir()
