...
def create_inputProcess_instance(outputQueue, profilerQueue, input_information, input_type, do_nothing):
...
def test_handle_pcap_and_interface(outputQueue, profilerQueue, input_type, input_information, do_nothing):
    # no need to test interfaces because in that case read_zeek_files runs in a loop and never returns
    inputProcess = create_inputProcess_instance(outputQueue, profilerQueue, input_information, input_type, do_nothing)
...
def test_read_zeek_folder(outputQueue, profilerQueue, input_type, input_information, do_nothing):
    inputProcess = create_inputProcess_instance(outputQueue, profilerQueue, input_information, input_type, do_nothing)
...
def test_handle_zeek_log_file(outputQueue, profilerQueue, input_type, input_information, do_nothing):
    inputProcess = create_inputProcess_instance(outputQueue, profilerQueue, input_information, input_type, do_nothing)
...
def test_handle_nfdump(outputQueue, profilerQueue, input_type, input_information, do_nothing):
    inputProcess = create_inputProcess_instance(outputQueue, profilerQueue, input_information, input_type, do_nothing)
...
def test_handle_binetflow(outputQueue, profilerQueue, input_type, input_information, do_nothing):
    inputProcess = create_inputProcess_instance(outputQueue, profilerQueue, input_information, input_type, do_nothing)
...
def test_handle_suricata(outputQueue, profilerQueue, input_type, input_information, do_nothing):
    inputProcess = create_inputProcess_instance(outputQueue, profilerQueue, input_information, input_type, do_nothing)
