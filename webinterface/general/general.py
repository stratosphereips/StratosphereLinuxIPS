...
general= Blueprint('general', __name__,  static_folder='static',static_url_path='/general/static', template_folder='templates')
...
def setBlockedProfileTWs():
    ...
    '''
    blockedProfileTWs = __database__.smembers('BlockedProfTW')
    data = []
    id = 0
