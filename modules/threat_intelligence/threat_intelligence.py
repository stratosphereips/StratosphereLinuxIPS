...
class Module(Module, multiprocessing.Process, URLhaus):
    ...
    def get_malicious_ip_ranges(self):
        ...
        """
        ip_ranges = self.rdb.get_malicious_ip_ranges()
    ...
    def set_evidence_malicious_ip(
        ...
        self.rdb.setInfoForIPs(ip, ip_info)
    ...
    def parse_local_ti_file(self, ti_file_path: str) -> bool:
        ...
        self.rdb.add_ips_to_IoC(malicious_ips)
        # Add all loaded malicious domains to the database
        self.rdb.add_domains_to_IoC(malicious_domains)
        self.rdb.add_ip_range_to_IoC(malicious_ip_ranges)
        self.rdb.add_asn_to_IoC(malicious_asns)
        return True
    ...
    def parse_ja3_file(self, path):
        ...
        self.rdb.add_ja3_to_IoC(ja3_dict)
        return True
    ...
    def parse_jarm_file(self, path):
        ...
        self.rdb.add_jarm_to_IoC(jarm_dict)
        return True
    ...
    def should_update_local_ti_file(self, path_to_local_ti_file: str) -> bool:
        ...
        data = self.rdb.get_TI_file_info(filename)
    ...
    def search_offline_for_ip(self, ip):
        ...
        ip_info = self.rdb.search_IP_in_IoC(ip)
    ...
    def ip_has_blacklisted_ASN(
        ...
        if asn_info := self.rdb.is_blacklisted_ASN(asn):
    ...
    def ip_belongs_to_blacklisted_range(
        ...
        for range in ranges_starting_with_octet:
            if ip_obj in ipaddress.ip_network(range):
                ...
                ip_info = self.rdb.get_malicious_ip_ranges()[range]
    ...
    def search_offline_for_domain(self, domain):
        ...
        (
            domain_info,
            is_subdomain,
        ) = self.rdb.is_domain_malicious(domain)
        if (
    ...
    def is_malicious_hash(self, flow_info):
        ...
        self.rdb.mark_as_analyzed_by_ti_module()
