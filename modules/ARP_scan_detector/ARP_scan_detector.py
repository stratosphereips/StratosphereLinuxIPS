...
class Module(Module, multiprocessing.Process):
    ...
    def check_arp_scan(self, profileid, twid, daddr, saddr, uid, ts, dst_mac):
        """
        ...
        if saddr==daddr and dst_mac=="ff:ff:ff:ff:ff:ff":
        ...
        while True:
            try:
                ...
                if message and message['channel'] == 'new_arp' and type(message['data'])==str:
                    ...
                    # arp flows don't have uids, the uids received are randomly generated by slips
                    uid = flow['uid']
                    self.check_arp_scan(profileid, twid, daddr, saddr, uid, ts, dst_mac)
