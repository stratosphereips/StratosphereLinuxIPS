...
class PeerTrustData:
    ...
    def to_dict(self, remove_histories: bool = False):
        data = {
            ...
            "service_history": [
                sh.to_dict() for sh in self.service_history
            ],  # Assuming ServiceHistory has to_dict
            "recommendation_history": [
                rh.to_dict() for rh in self.recommendation_history
            ],  # Assuming RecommendationHistory has to_dict
        }
    ...
    def from_dict(cls, data):
        return cls(
            info=PeerInfo.from_dict(
                data["info"]
            ),  # Assuming PeerInfo has from_dict method
            ...
            initial_reputation_provided_by_count=data[
...
def trust_data_prototype(
    peer: PeerInfo, has_fixed_trust: bool = False
) -> PeerTrustData:
