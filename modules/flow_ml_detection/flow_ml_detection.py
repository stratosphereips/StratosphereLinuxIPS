...
class FlowMLDetection(IModule):
    ...
    def init(self):
        ...
        self.model_path = "./modules/flow_ml_detection/model.bin"
        self.scaler_path = "./modules/flow_ml_detection/scaler.bin"
                ...
                flows.append(
                    {
                        ...
                        "label": "Malware",
                        "module_labels": {
                            "flow_alerts-long-connection": "Malware"
                        },
                    }
                )
                flows.append(
                    {
                        ...
                        "label": "Normal",
                        "module_labels": {
                            "flow_alerts-long-connection": "Normal"
                        },
                    }
                )
