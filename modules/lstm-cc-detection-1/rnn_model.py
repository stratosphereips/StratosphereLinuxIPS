...
# Load the dataset
dataset_file='./datasets/all_datasets_raw_v3'
...
history = model.fit(train_x_data, train_y_data, epochs=num_epochs, batch_size=batch_size, validation_split=0.1, verbose=1, shuffle=True)
...
model.save('lstm_model_v_ondra3.h5') 