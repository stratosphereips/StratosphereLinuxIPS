...
#
# dataset_file='modules/lstm-cc-detection-1/datasets/all_datasets_raw'
...
# model.add(Embedding(max_ord_value, 64, input_length=features_per_sample))
# # GRU is the main RNN layer
# model.add(GRU(256, return_sequences=False, input_shape=(num_outtuples, features_per_sample)))
