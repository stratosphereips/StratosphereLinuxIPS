...
class AnomalyDetectionHTTPS(IModule):
    ...
    def finalize_hour_bucket(self, profileid: str, state: HostState):
        ...
        features = {
            ...
            "ja3_changes": float(bucket.ja3_changes),
    ...
    def process_ssl_event(
        ...
        is_new_ja3_for_server = bool(ja3) and ja3 not in server_ja3_set
        ...
        if uid:
            bucket.uids.add(uid)
        if is_new_ja3_for_server:
            bucket.ja3_changes += 1
        ...
        if bytes_total is not None:
            ...
            self.log_event(
                ...
                metrics={
                    ...
                    "alpha": alpha,
                    "fit_method": (
                        flow_training_fit_method if alpha is None else "ewma"
                    ),
                },
            )
